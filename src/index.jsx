...
root.render(
  //aki está renderizando uma div com o ID 'root', e tudo o que for passado aki dentro será renderizado dentro da div 'root' que se encontra no index.html, ou seja, por ser de marcação será exibida no navegador ao renderizar.
  <React.StrictMode>
    <Home />{" "}
